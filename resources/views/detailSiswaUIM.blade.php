    ...
    <div class="container p-5">
        ...
        <div class="row">
            ...
            <div class="col-md-8 ">
                ...
                <small class="text-danger">*Fitur ini hanya disediakan untuk pendaftar registrasi bersama musyrif</small>
                <table class="table table-sm">
                    <tr>
                        <td>Musyrif</td>
                        <td>{{$dataMadinah->musyrifName}} - <a href="https://wa.me/{{ $dataMadinah->noTelp }}" target="_blank">Hubungi via Whatsapp</a></td>
                    </tr>
                    <tr>
                        <td>Status Pendaftaran</td>
                    <td>@if($dataMadinah->selesaiDidaftarkan) Selesai @elseif($dataMadinah->jadwalDidaftarkan) Menunggu didaftarkan @else Menunggu Kelengkapan Data @endif</td>
                    </tr>
                    <tr>
                        <td>Jadwal Didaftarkan</td>
                        <td>@if($dataMadinah->jadwalDidaftarkan) {{\Carbon\Carbon::parse($dataMadinah->jadwalDidaftarkan)->isoFormat('DD MM YYYY')}} @else Menunggu Kelengkapan Data @endif</td>
                    </tr>
                    <tr>
                        <td>Keterangan</td>
                        <td>@if($dataMadinah->keterangan) {{$dataMadinah->keterangan}} @else - @endif</td>
                    </tr>
                </table>
                ...
                <table class="table table-sm">
                    ...
                    <tr>
                        <td colspan="2">
                            <small class="text-danger">*Untuk melengkapi berkas yang masih kosong, bisa hubungi musyrif masing-masing via <a href="https://wa.me/{{ $dataMadinah->noTelp }}">whatsapp.</a></small>
                        </td>
                    </tr>
                </table>
