                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            @endif
                            <input type="file" class="form-control-file mt-2" id="photoWhiteBG" name="photoWhiteBG">
                            @error('photoWhiteBG')
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="KTP" name="KTP">
                            @error('KTP')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="KTPArab" name="KTPArab">
                            @error('KTPArab')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="akte" name="akte">
                            @error('akte')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="akteArab" name="akteArab">
                            @error('akteArab')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="KK" name="KK">
                            @error('KK')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="surkes" name="surkes">
                            @error('surkes')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="surkesArab" name="surkesArab">
                            @error('surkesArab')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="SKKB" name="SKKB">
                            @error('SKKB')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="tazkiyah" name="tazkiyah">
                            @error('tazkiyah')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="SKCK" name="SKCK">
                            @error('SKCK')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="SKCKArab" name="SKCKArab">
                            @error('SKCKArab')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="ijazahIM" name="ijazahIM">
                            @error('ijazahIM')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="ijazahMA" name="ijazahMA">
                            @error('ijazahMA')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="transkripIjazahIM" name="transkripIjazahIM">
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="transkripIjazahMA" name="transkripIjazahMA">
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="raporMA" name="raporMA">
                            @error('raporMA')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="raporIM" name="raporIM">
                            @error('raporIM')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="rapor1AIM" name="rapor1AIM">
                            @error('rapor1AIM')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="rapor1BIM" name="rapor1BIM">
                            @error('rapor1BIM')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="rapor2AIM" name="rapor2AIM">
                            @error('rapor2AIM')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="rapor2BIM" name="rapor2BIM">
                            @error('rapor2BIM')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="rapor3AIM" name="rapor3AIM">
                            @error('rapor3AIM')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="rapor3BIM" name="rapor3BIM">
                            @error('rapor3BIM')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="rapor1AMA" name="rapor1AMA">
                            @error('rapor1AMA')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="rapor1BMA" name="rapor1BMA">
                            @error('rapor1BMA')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="rapor2AMA" name="rapor2AMA">
                            @error('rapor2AMA')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="rapor2BMA" name="rapor2BMA">
                            @error('rapor2BMA')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="rapor3AMA" name="rapor3AMA">
                            @error('rapor3AMA')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <small class="text-muted">atau ganti dengan dokumen baru</small><br>
                            @endif
                            <input type="file" class="form-control-file mt-2" id="rapor3BMA" name="rapor3BMA">
                            @error('rapor3BMA')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            </div>
